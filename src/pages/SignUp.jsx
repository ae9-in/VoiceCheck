...
import { User, Mail, Lock, ArrowRight, Loader2, Shield } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 overflow-hidden font-sans select-none">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30 z-0">
        <div className="absolute -top-[20%] -left-[10%] w-[500px] h-[500px] bg-indigo-650/35 blur-[120px] rounded-full"></div>
        <div className="absolute -bottom-[20%] -right-[10%] w-[400px] h-[400px] bg-emerald-650/25 blur-[100px] rounded-full"></div>
      </div>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center space-y-3">
        ...
        <p className="text-sm text-slate-450 max-w-[280px] mx-auto font-medium leading-relaxed">
          Sign up to setup a new voice diagnostics workspace.
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4 sm:px-0">
        <div className="bg-slate-900/60 backdrop-blur-xl py-8 px-6 shadow-2xl rounded-2xl border border-slate-800/80 sm:px-10">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => { setConfirmPassword(e.target.value); setFormErrors(prev => ({ ...prev, confirmPassword: null })); }}
          ...
          <div className="mt-6 border-t border-slate-800/80 pt-6 text-center">
            ...
            <Link to="/login" className="text-xs text-indigo-400 hover:text-indigo-300 font-bold transition-colors">
              Sign in instead
            </Link>
          </div>
        </div>
